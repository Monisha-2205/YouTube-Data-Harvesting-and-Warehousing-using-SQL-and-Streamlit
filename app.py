import sys
sys.path.append(r'C:\Users\Harsha\Downloads') 
...
def connect_to_mysql():
    try:
        connection = pymysql.connect(
            host="localhost",
            user="root",
            password="Monishagowda8080",  # Replace with the correct password
            database="youtube"
        )
        return connection
...
# Channel Details Page
    ...
    my_connection = pymysql.connect(host="127.0.0.1", user="root", password="Monishagowda8080", database='youtube')
...
# SQL Queries Page
    ...
    my_connection = pymysql.connect(host="127.0.0.1", user="root", password="Monisha8080!")
    mycursor = my_connection.cursor()
...
st.markdown("""
    <hr>
    <h4 style='text-align: center;'>Created by Monisha B A</h4>
    """, unsafe_allow_html=True)